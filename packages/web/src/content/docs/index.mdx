...
template: splash
hero:
  tagline: Client library for MobyGames API in Node.js
  image:
    file: '@assets/whale.png'
  actions:
    - text: Get Started
      link: /mobygames/guides/getting-started/
      icon: right-arrow
      variant: primary
    - text: View on GitHub
      link: https://github.com/falsepopsky/mobygames
      variant: secondary
      icon: external
---
...
<Grid>
  <Card
    ...
    details="It uses the native fetch and URL modules from Node.js to make HTTP requests and handle the creation of URL targets">
    <svg
      height="32"
      width="32"
  ...
  <Card
    ...
    details="Interact with and query multiple API endpoints effortlessly using a user-friendly interface">
    <svg
      height="32"
      width="32"
      xmlns="http://www.w3.org/2000/svg"
      ...
      aria-hidden="true"
      class="h-8 w-8">
      <path d="M30,14H28A10.0113,10.0113,0,0,0,18,4V2A12.0137,12.0137,0,0,1,30,14Z" />
      <path
        d="M26 14H24a6.0067 6.0067 0 00-6-6V6A8.0092 8.0092 0 0126 14zM16 28V24.96a9.9124 9.9124 0
  ...
  <Card title="TypeScript" details="Utilizes TypeScript to enhance development with strong typing capabilities">
    <svg
      height="32"
      width="32"
      viewBox="0 0 27 26"
